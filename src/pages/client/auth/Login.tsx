...
const Login = () => {
  const { register, handleSubmit, errors, onSubmit, watch } = handleAuthForm(
    LoginSchema,
    "Đăng nhập"
  );
  watch("remember");
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Đăng nhập
            </button>
          </div>
